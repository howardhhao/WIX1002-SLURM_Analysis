        ...
        Papa.parse(csvText, {
          ...
          complete: (results) => {
            const parsedData = results.data
              .map(row => ({
                month: row.Month,
                value: parseInt(row.Complete, 10)
              }))
    ...
    <><div className='dashboard-container'>
       ...
       <div className='content'>
              ...
              <div className='total-amount-card'>
                ...
                <p className='total-amount-card-title'>Total Jobs Completed</p>
              </div>

              <div className='total-amount-card'>
                <p className='total-amount-card-value'>{highestJobs.value}</p>
                <p className='total-amount-card-title'>Highest Jobs Completed (<strong>{highestJobs.month}</strong>)</p>
              </div>

            <div className='total-amount-card'>
                <p className='total-amount-card-value'>{lowestJobs.value}</p>
                <p className='total-amount-card-title'>Lowest Jobs Completed (<strong>{lowestJobs.month}</strong>)</p>
            </div>
