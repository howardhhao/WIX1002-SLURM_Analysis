    ...
    <div className='dashboard-container'>
      ...
      <div className='content'>
        ...
        <div className='total-amount-card'>
          ...
          <p className='total-amount-card-title'>Total Jobs Completed Exit Status 0</p>
        </div>

        <div className='total-amount-card'>
          <p className='total-amount-card-value'>{highestJobs.value}</p>
          <p className='total-amount-card-title'>Highest Jobs Completed Exit Status 0 (<strong>{highestJobs.month}</strong>)</p>
        </div>

        <div className='total-amount-card'>
          <p className='total-amount-card-value'>{lowestJobs.value}</p>
          <p className='total-amount-card-title'>Lowest Jobs Completed Exit Status 0 (<strong>{lowestJobs.month}</strong>)</p>
        </div>

        </div>

        <p className='content-title-2'>Breakdown Analysis</p>
        <div className='jobCompleted-card'>
