    ...
    <div className='dashboard-container'>
      ...
      <div className='content'>
        ...
        <div className='total-amount-card'>
          ...
          <p className='total-amount-card-title'>Total Jobs Killed</p>
        </div>

        <div className='total-amount-card'>
          <p className='total-amount-card-value'>{highestJobs.value}</p>
          <p className='total-amount-card-title'>Highest Jobs Killed (<strong>{highestJobs.month}</strong>)</p>
        </div>

        <div className='total-amount-card'>
          <p className='total-amount-card-value'>{lowestJobs.value}</p>
          <p className='total-amount-card-title'>Lowest Jobs Killed (<strong>{lowestJobs.month}</strong>)</p>
        </div>

        </div>

        <p className='content-title-2'>Breakdown Analysis</p>
        <div className='jobKilled-card'>
