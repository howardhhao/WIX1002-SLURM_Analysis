      ...
      <TopNavBar/>
        ...
        <div className='small-card-container'>
          <div className='total-amount-card'>
            ...
            <p className='total-amount-card-title'>Total Jobs Submitted</p>
          </div>
          <div className='total-amount-card'>
            <p className='total-amount-card-value'>{highestJobs.value}</p>
            <p className='total-amount-card-title'>Highest Jobs Submitted (<strong>{highestJobs.month}</strong>)</p>
          </div>
          <div className='total-amount-card'>
