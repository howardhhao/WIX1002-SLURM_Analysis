    ...
    <div className='dashboard-container'>
      ...
      <div className='content'>
        ...
        <div className='total-amount-card'>
          ...
          <p className='total-amount-card-title'>Total Jobs TLE</p>
        </div>

        <div className='total-amount-card'>
          <p className='total-amount-card-value'>{highestJobs.value}</p>
          <p className='total-amount-card-title'>Highest Jobs TLE (<strong>{highestJobs.month}</strong>)</p>
        </div>

        <div className='total-amount-card'>
          <p className='total-amount-card-value'>{lowestJobs.value}</p>
          <p className='total-amount-card-title'>Lowest Jobs TLE (<strong>{lowestJobs.month}</strong>)</p>
        </div>
